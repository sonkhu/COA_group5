class DoraBell{
  ...
  void show(){
    ...
    // 종 그리기
    fill(255, 220, 0);
    ellipse(x, y + d * 50/100, d * 20/100, d * 15/100);

    stroke(0);
    strokeWeight(3);
    line(x - d * 9/100, y + d * 47/100, x + d * 9/100, y + d * 47/100);

    fill(0);
    ellipse(x, y + d * 53/100, d * 5/100, d * 5/100);

    strokeWeight(2);
    line(x, y + d * 56/100, x, y + d * 62/100);
    strokeWeight(1);
  }
}
