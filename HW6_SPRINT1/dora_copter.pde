class DoraCopter{
  ...
  void show(){
    ...
    // 헬리콥터 날개
    fill(255, 255, 120);
    rect(x - d * 20/100, y - d * 77.5/100, d * 40/100, d * 5/100);
    rect(x - d * 2.5/100, y - d * 95/100, d * 5/100, d * 40/100);

    fill(200);
    ellipse(x, y - d * 75/100, d * 10/100, d * 6/100);

    fill(230, 200, 140);
    rect(x - d * 2.5/100, y - d * 70/100, d * 5/100, d * 20/100);
  }
}
